...
import com.zuoni.zuoni_common.utils.common.LogUtil;
...
//                        getCopyDataICRF();
                        Message msg2 = Message.obtain(handler, getCopyDataSuccess);
                        ...
                        public void run() {
                            ...
                            for (int j2 = 0; j2 < groupBinds.size(); j2++) {
                                ...
                                if (meterTypeNo.equals("04")) {
                                    ...
                                    copyDataICRF.setMeterNo(groupBinds.get(j2).getMeterNo());
                                    ...
                                    copyDataICRF.setMeterName(groupBinds.get(j2).getMeterName());
...
//                                    }
                                    ...
                                    copyData.setMeterNo(groupBinds.get(j2).getMeterNo());
                                    copyData.setMeterName(groupBinds.get(j2).getMeterName());
...
//						+ "条表具数据");
                    if (groupBinds != null) {
                        tvDataDownTips.setText("下载完毕，总计导入" + groupBinds.size()
                                + "条表具数据");
                    }
...
//					}.start();
    ...
    private void getCopyDataICRF() {
        ...
        AsyncHttpClient client = new AsyncHttpClient();
        RequestParams params = new RequestParams();
        LogUtil.i("zzzzz", "url=" + url + "bookNo=" + bookNo);
