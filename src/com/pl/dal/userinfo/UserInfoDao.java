...
public class UserInfoDao {
    ...
    public void putUserInfo(UserInfo userInfo) {
        ...
        values.put("xiNingUnitPrice",userInfo.getXiNingUnitPrice());
    ...
    public UserInfo getUserInfo(String tableNumber) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            userInfo.setXiNingUnitPrice(cursor.getString(cursor.getColumnIndex("xiNingUnitPrice")));
        }
        return userInfo;
    }
